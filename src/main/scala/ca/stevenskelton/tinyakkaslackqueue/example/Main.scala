...
object Main extends App {
  ...
  private implicit val httpLogger = SlackLoggerFactory.logToSlack(backupLogger.getName, slackConfig, Some(backupLogger))(SystemMaterializer(httpActorSystem).materializer)
