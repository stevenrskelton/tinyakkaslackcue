...
import akka.http.scaladsl.server.Directives.{as, complete, entity, extractExecutionContext, extractRequestContext}
...
class SlackEventRoute(slackClient: SlackClient, slackTaskFactories: SlackTaskFactories)(implicit materializer: Materializer, logger: Logger) {
